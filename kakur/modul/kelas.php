                                        ...
                                        <table width="100%" class="table table-striped table-bordered table-hover table-paginate" id="dataTables-example">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href='#edit_modal' class='btn btn-warning btn-xs' data-toggle='modal' data-id="<?php echo $row['kd_kelas'] ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a></td>
                                                </tr>
                                            <?php } ?>
                                            </tbody>
                                        </table>
