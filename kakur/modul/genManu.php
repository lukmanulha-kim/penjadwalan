                        ...
                        <div class="panel-body">
                            ...
                            <!-- =======================LIHAT======================== -->
                                ...
                                <div class="tab-pane fade" id="cetak">
                                    <br>
                                    <div class="col-lg-6">
                                        <form action="pdf/lap_jad.php" method="post">
                                ...
                                <div class="tab-pane fade in active" id="tambah">
                                    <br>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                <button type="button" class="btn btn-info btn-lg btn-block btn-sm" href="#myModal" data-toggle="modal" data-target="#myModal">Pilih</button>
                                                </div>
                                    ...
                                    <?php
                                        ...
                                        if (@$simpan) {
                                            ...
                                            }elseif($resul['kd_hari']==$_POST['hari']){
