...
$pdf->Cell(5, 0.7, 'SENIN', 1, 1, 'C');
$pdf->Cell(0.8, 0.7, 'No', 1, 0, 'C');
$pdf->Cell(2.7, 0.7, 'Pukul', 1, 0, 'C');
$pdf->Cell(1.5, 0.7, 'Kode', 1, 1, 'C');
...
while($lihat=mysqli_fetch_array($query)){
	...
	$pdf->Cell(1.5, 0.6, $lihat['kode_mapel']."".$lihat['kd_guru'],1, 1, 'C');
