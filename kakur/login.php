            ...
            <div class="col-md-4 col-md-offset-4">
                <div id="login">
                    ...
                    <?php
                        ...
                        elseif ($row['uname'] == $username && $row['pass'] == $pass && $row['jabatan'] == "Kepala Sekolah" && $row['status_guru'] == 1) {
                            session_start();
                          $_SESSION['userdata'] = $row['kd_guru'];
                          $_SESSION['username'] = $row['nama_guru'];
                          $_SESSION['jabatan'] = $row['jabatan'];
                        ...
                        <form role="form" action="" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Username" name="nip" autofocus required>
                                </div>
                                <div class="form-group">
