            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li><a href="?modul=set&id=<?php echo $_SESSION['userdata']; ?>"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li> -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="?modul=penugasan"><i class="fa fa-edit fa-fw"></i> Lihat Data Penugasan</a>
                        </li> -->
                        <li>
                            <a href="?modul=penjadwalan"><i class="fa fa-edit fa-fw"></i> Lihat Jadwal</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
