<tr>
	<td colspan="30" style="text-align: center;">Selasa</td>
</tr>
<tr>
...
<?php 
	$query = mysqli_query($kon, "SELECT * FROM
                                ...
                                Inner Join tb_hari ON tb_hari.kd_hari = tb_jadwal.kd_hari
                                Inner Join tb_jam ON tb_jam.kd_jam = tb_jadwal.kd_jam
                                WHERE tb_jadwal.kd_jam=1 and tb_jadwal.kd_hari=2");
	while ($tampil=mysqli_fetch_array($query, MYSQLI_ASSOC)) {
?>
...
<?php 
	$query = mysqli_query($kon, "SELECT * FROM
                                ...
                                Inner Join tb_hari ON tb_hari.kd_hari = tb_jadwal.kd_hari
                                Inner Join tb_jam ON tb_jam.kd_jam = tb_jadwal.kd_jam
                                WHERE tb_jadwal.kd_jam=2 and tb_jadwal.kd_hari=2");
	while ($tampil=mysqli_fetch_array($query, MYSQLI_ASSOC)) {
?>
	<td style="text-align: center;"><?php echo $tampil['kode_mapel']."".$tampil['kd_guru']; ?></td>
<?php } ?>
...
<?php 
	$query = mysqli_query($kon, "SELECT * FROM
                                ...
                                Inner Join tb_hari ON tb_hari.kd_hari = tb_jadwal.kd_hari
                                Inner Join tb_jam ON tb_jam.kd_jam = tb_jadwal.kd_jam
                                WHERE tb_jadwal.kd_jam=3 and tb_jadwal.kd_hari=2");
	while ($tampil=mysqli_fetch_array($query, MYSQLI_ASSOC)) {
?>
	<td style="text-align: center;"><?php echo $tampil['kode_mapel']."".$tampil['kd_guru']; ?></td>
<?php } ?>
...
<?php 
	$query = mysqli_query($kon, "SELECT * FROM
                                ...
                                Inner Join tb_hari ON tb_hari.kd_hari = tb_jadwal.kd_hari
                                Inner Join tb_jam ON tb_jam.kd_jam = tb_jadwal.kd_jam
                                WHERE tb_jadwal.kd_jam=4 and tb_jadwal.kd_hari=2");
	while ($tampil=mysqli_fetch_array($query, MYSQLI_ASSOC)) {
?>
	<td style="text-align: center;"><?php echo $tampil['kode_mapel']."".$tampil['kd_guru']; ?></td>
<?php } ?>
...
<?php 
	$query = mysqli_query($kon, "SELECT * FROM
                                ...
                                Inner Join tb_hari ON tb_hari.kd_hari = tb_jadwal.kd_hari
                                Inner Join tb_jam ON tb_jam.kd_jam = tb_jadwal.kd_jam
                                WHERE tb_jadwal.kd_jam=5 and tb_jadwal.kd_hari=2");
	while ($tampil=mysqli_fetch_array($query, MYSQLI_ASSOC)) {
?>
	<td style="text-align: center;"><?php echo $tampil['kode_mapel']."".$tampil['kd_guru']; ?></td>
<?php } ?>
...
<?php 
	$query = mysqli_query($kon, "SELECT * FROM
                                ...
                                Inner Join tb_hari ON tb_hari.kd_hari = tb_jadwal.kd_hari
                                Inner Join tb_jam ON tb_jam.kd_jam = tb_jadwal.kd_jam
                                WHERE tb_jadwal.kd_jam=6 and tb_jadwal.kd_hari=2");
	while ($tampil=mysqli_fetch_array($query, MYSQLI_ASSOC)) {
?>
	<td style="text-align: center;"><?php echo $tampil['kode_mapel']."".$tampil['kd_guru']; ?></td>
<?php } ?>
...
<?php 
	$query = mysqli_query($kon, "SELECT * FROM
                                ...
                                Inner Join tb_hari ON tb_hari.kd_hari = tb_jadwal.kd_hari
                                Inner Join tb_jam ON tb_jam.kd_jam = tb_jadwal.kd_jam
                                WHERE tb_jadwal.kd_jam=7 and tb_jadwal.kd_hari=2");
	while ($tampil=mysqli_fetch_array($query, MYSQLI_ASSOC)) {
?>
	<td style="text-align: center;"><?php echo $tampil['kode_mapel']."".$tampil['kd_guru']; ?></td>
<?php } ?>
...
<?php 
	$query = mysqli_query($kon, "SELECT * FROM
                                ...
                                Inner Join tb_hari ON tb_hari.kd_hari = tb_jadwal.kd_hari
                                Inner Join tb_jam ON tb_jam.kd_jam = tb_jadwal.kd_jam
                                WHERE tb_jadwal.kd_jam=8 and tb_jadwal.kd_hari=2");
	while ($tampil=mysqli_fetch_array($query, MYSQLI_ASSOC)) {
?>
	<td style="text-align: center;"><?php echo $tampil['kode_mapel']."".$tampil['kd_guru']; ?></td>
<?php } ?>
